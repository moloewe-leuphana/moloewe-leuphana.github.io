...
var abstractText = 'The MoLöwe is a new approach for participative workshops developed at the Faculty of Sustainability of Leuphana. This digital environment allows to visualise future scenarios and experience the effects of adjusted model parameters in real time. The hardware includes five 65’’ screens that create an immersive environment and five tablets that allow participants to interact with the screens’ content. The entire set-up is mobile and can therefore be put into action on site. For this reason alone, scientist can reach a larger target audience. Complex problems are fanned out and visualised in comprehensible steps across the screens. Participants can experience and design interactive scenarios. To this end, the MoLöwe allows to visualise effects of interventions in real time, illustrate the interplay between local actions and global drivers and make abstract facts tangible.';
  ...
  return (
    ...
    <Layout title={`Mobile Lösungswerkstatt (MoLöwe)`}>
        ...
        <div className={styles.WhyMoloeweDiv}>
            <span className={styles.WhyMoloeweSpan}>Why MoLöwe?</span>
        </div>
